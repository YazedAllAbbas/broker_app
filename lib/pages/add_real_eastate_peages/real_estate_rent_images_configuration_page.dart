...
import 'package:broker/pages/add_real_eastate_peages/rent_pages/confirm_adding_real_estate_rant_page.dart';
...
class RealEstateRentImagesConfigurationPage extends StatefulWidget {
  ...
  const RealEstateRentImagesConfigurationPage(
      {super.key, required this.formData, required this.forSale});
                  ...
                  child: CustomButton3(
                    ...
                    fun: () {
                      ...
                      Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => widget.forSale
                              ? ConfirmAddingRealEstateSalePage(
                                  formData: widget.formData)
                              : ConfirmAddingRealEstateRantPage(
                                  formData: widget.formData)));
                    },
                    primaryColor: true,
                  )),
