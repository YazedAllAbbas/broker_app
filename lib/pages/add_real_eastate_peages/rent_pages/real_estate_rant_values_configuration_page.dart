...
class RealEstateRantValuesConfigurationPage extends StatefulWidget {
  const RealEstateRantValuesConfigurationPage({super.key});

  @override
  State<RealEstateRantValuesConfigurationPage> createState() =>
      _RealEstateRantValuesConfigurationPageState();
}

class _RealEstateRantValuesConfigurationPageState
    extends State<RealEstateRantValuesConfigurationPage> {
  ...
  String? lease; // عقد الإجار (سنوي أو شهري)
  ...
  TextEditingController priceForOneMonth =
      TextEditingController(); // تكلفة إجار الشهر الواحد
          ...
          child: ListView(
            children: [
              ...
              DropDownTile(
                title: "عقد الإجار",
                selectedValue: lease,
                dropdownValueList: Constants.leaseList,
                dropDownfun: (newValue) {
                  setState(() {
                    lease = newValue;
                  });
                          ...
                          Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) =>
                              ...
                              formData: {
                                ...
                                'priceForOneMonth': priceForOneMonth.text,
